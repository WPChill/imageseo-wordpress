    ...
    <div class="imageseo-block__inner imageseo-block__inner">
        <div id="form-register">
            <div>
                ...
                <input type="email" name="email" class="regular-text imageseo-input" id="register-email">
            </div>
            <br />
            <div>
                <label for="password">
                ...
                <input type="password" name="password" class="regular-text imageseo-input" id="register-password">
            </div>
