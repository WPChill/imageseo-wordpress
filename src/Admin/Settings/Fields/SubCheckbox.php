...
class SubCheckbox extends Admin_Fields {
	 ...
	 * @param String $parent
	 */
	public function __construct( $name, $value, $cb_label, $parent ) {
	...
	public function get_value() {
		//var_dump(imageseo_get_service( 'Option' )->getOptions( )[$this->get_parent()]);
		return imageseo_get_service( 'Option' )->getOption( $this->parent )[ $this->get_name() ]; // TODO: Change the autogenerated stub
	}
