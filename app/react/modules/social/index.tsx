			...
			<div className="mb-4">
				<AlertSimple icon={IconsAlert.INFORMATION} blue>
					<h3 className="text-lg leading-6 font-medium text-gray-900">
						{__("What are Social cards? ", "imageseo")}
					</h3>
					<p className="mt-2 max-w-4xl text-sm text-gray-500">
						{__(
							"Social cards are used by Twitter, LinkedIn & Facebook to display the preview of your pages and posts. Tuning Social Card will increase your engagement on Social Media.",
							"imageseo"
						)}
					</p>
				</AlertSimple>
