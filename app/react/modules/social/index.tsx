...
function SocialMediaWithProviders() {
	...
	return (
		<div className="flex">
			<div className="border rounded-md overflow-hidden w-1/2 mr-4">
				<div className="bg-white p-6">
					...
					<div className="mb-4">
						<label htmlFor="layout" className="text-sm font-bold">
							{__("Layout", "imageseo")}
						</label>
						<select
							id="layout"
						...
						<div className="flex items-center">
							<div className="mr-2">
								<SCPicker
									...
									onClick={() =>
										handleOpenColorPicker("textColor")
									}
								/>
								{textColorPickerOpen && (
									<div
							...
							<div className="flex items-center">
								<div className="mr-2">
									<SCPicker
										...
										onClick={() =>
											handleOpenColorPicker("starColor")
										}
									/>
									{starColorPickerOpen && (
										<div
