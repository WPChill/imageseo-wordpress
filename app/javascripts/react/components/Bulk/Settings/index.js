							...
							<div className="imageseo-mt-3">
								...
								<ul>
									...
									<li>
										...
										<p style={{ fontSize: 14 }}>
											If the image is a headline image,
											this will be the title of the post.
										</p>
									</li>
									<li>
										<strong>keyword_X</strong> (Replace X by
										a number.)
										<p style={{ fontSize: 14 }}>
											Keyword generated by the AI. X = 1
											corresponds to the most important
											keyword we detect
										</p>
									</li>
								</ul>
