        ...
        $.ajax({
            ...
            success:(response) => {
                ...
                if(!success){
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Registration did not work, please visit https://app.imageseo.io/register',
                        icon: 'error',
                        confirmButtonText: 'Register',
                        onClose: ()=> {
                            window.open('https://app.imageseo.io/register', '_blank');
                        }
                      })
                }
                ...
                $("#js-imageseo-register h3").text("Great! You are registered and we have configured your API key")
                Swal.fire({
                    title: 'Great!',
                    text: 'You are registered and we have configured your API key',
                    icon: 'success',
